...
public class NoteEditorTest {
    ...
    // this is for vaild process of editing note

    public void VaildNoteEditProcess() {
        ...
        onView(withId(R.id.editText))
                .perform(click())
                .perform(typeText("i like short run"));

    }

    @Test

    public void VaildNoteEditProcess2() {
        // Context of the app under test.
